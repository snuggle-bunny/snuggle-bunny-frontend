...
const Terms = () => {
  return (
    <div className="terms-page">
      ...
      <h2>OVERVIEW</h2>
      <p>
        This website is operated by snuggle bunny. Throughout the site, the
        terms “we”, “us” and “our” refer to snuggle bunny. snuggle bunny offers
      ...
      <p>
        We are not responsible or liable for any colour change in the fabric,
        whereby the fabric has been dyed, discoloured when exposed to other
        products, sunlight or chemicals.
      </p>
      <p>
        We cannot accept the liability for fabric loss attributed to shrinkage.{" "}
      </p>
      <p>
        We accept no responsibility or liability if the natural dyed fabric
        transfers colour to other materials and products. Indigo and dark
        colours may transfer colour and should be pre-washed.
      </p>
      <p>
        The products available in our website may be used and may vary in
        degrees of colour, ageing and wear. We are committed to preserving the
        environment and therefore reuse products, ensuring that they remain the
        best quality and are sanitised. If you are not comfortable purchasing
        used clothing you should not purchase products from this website.
      </p>
      ...
      <p>
        In no case shall snuggle bunny, our directors, officers, employees,
      ...
      <p>
        You agree to indemnify, defend and hold harmless snuggle bunny and our
      ...
      <p>
        ...
        snugglebunnyclothing@gmail.com.
      </p>
    </div>
  );
};
