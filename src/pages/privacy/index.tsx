...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy-page">
      ...
      <p>
        At snuggle bunny we are committed to protecting your personal
        information. We appreciate how important it is to you, and we respect
        that.
      </p>
      <p>
        This Privacy Policy provides detailed information on how your personal
        information is collected, used, and shared when you visit or make a
        purchase from www.snugglebunnyclothing.com (the “Site”).
      </p>
